...
/* 
 * File:   qrfittingdemo.cpp
 * Author: matlab
 *
 * Created on October 13, 2016, 1:59 PM
 */
...
int solve_system(const int print_data, const gsl_multilarge_linear_type * T, const double lambda, const size_t n, const size_t p, gsl_vector * c)
{
