...
LDLIBSOPTIONS=-L/usr/local/lib -L../install/libcinstall/lib ../IsotopeFitLib/dist/Debug/GNU-Linux/libifl.a /usr/local/lib/libmatio.a /usr/local/lib/libhdf5.a /usr/local/lib/libhdf5_cpp.a /usr/local/lib/libsz.a /usr/local/lib/libz.a /usr/lib/x86_64-linux-gnu/libc.a /usr/lib/x86_64-linux-gnu/libdl.a /usr/local/lib/libgsl.a /usr/local/lib/libgslcblas.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/isotopefitter

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/isotopefitter: ../IsotopeFitLib/dist/Debug/GNU-Linux/libifl.a
...
${OBJECTDIR}/src/DebugUtils.o: src/DebugUtils.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DebugUtils.o src/DebugUtils.cpp

${OBJECTDIR}/src/DesignMatrix.o: src/DesignMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DesignMatrix.o src/DesignMatrix.cpp

${OBJECTDIR}/src/IsotopeFitter.o: src/IsotopeFitter.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IsotopeFitter.o src/IsotopeFitter.cpp

${OBJECTDIR}/src/LeastSquares.o: src/LeastSquares.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LeastSquares.o src/LeastSquares.cpp

${OBJECTDIR}/storage/Snippets.o: storage/Snippets.cpp
	${MKDIR} -p ${OBJECTDIR}/storage
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/storage/Snippets.o storage/Snippets.cpp
...
${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/fittingtest.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS}  -static 

${TESTDIR}/TestFiles/f5: ${TESTDIR}/tests/fittingtest2.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f5 $^ ${LDLIBSOPTIONS}  -static 
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/h5openread.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS}  -static 

${TESTDIR}/TestFiles/f4: ${TESTDIR}/tests/matiotest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f4 $^ ${LDLIBSOPTIONS}  -static 

${TESTDIR}/TestFiles/f6: ${TESTDIR}/tests/qrfittingdemo.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f6 $^ ${LDLIBSOPTIONS}  -static 


${TESTDIR}/tests/fittingtest.o: tests/fittingtest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/fittingtest.o tests/fittingtest.cpp


${TESTDIR}/tests/fittingtest2.o: tests/fittingtest2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/fittingtest2.o tests/fittingtest2.cpp


${TESTDIR}/tests/gsltest.o: tests/gsltest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/gsltest.o tests/gsltest.cpp


${TESTDIR}/tests/h5openread.o: tests/h5openread.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/h5openread.o tests/h5openread.cpp


${TESTDIR}/tests/matiotest.o: tests/matiotest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -I. -std=c++14 -O0 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/matiotest.o tests/matiotest.cpp


${TESTDIR}/tests/qrfittingdemo.o: tests/qrfittingdemo.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/qrfittingdemo.o tests/qrfittingdemo.cpp
...
${OBJECTDIR}/src/DebugUtils_nomain.o: ${OBJECTDIR}/src/DebugUtils.o src/DebugUtils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DebugUtils_nomain.o src/DebugUtils.cpp;\
	else  \
...
${OBJECTDIR}/src/DesignMatrix_nomain.o: ${OBJECTDIR}/src/DesignMatrix.o src/DesignMatrix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DesignMatrix_nomain.o src/DesignMatrix.cpp;\
	else  \
...
${OBJECTDIR}/src/IsotopeFitter_nomain.o: ${OBJECTDIR}/src/IsotopeFitter.o src/IsotopeFitter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IsotopeFitter_nomain.o src/IsotopeFitter.cpp;\
	else  \
...
${OBJECTDIR}/src/LeastSquares_nomain.o: ${OBJECTDIR}/src/LeastSquares.o src/LeastSquares.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LeastSquares_nomain.o src/LeastSquares.cpp;\
	else  \
...
${OBJECTDIR}/storage/Snippets_nomain.o: ${OBJECTDIR}/storage/Snippets.o storage/Snippets.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I../install/libcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/storage/Snippets_nomain.o storage/Snippets.cpp;\
	else  \
