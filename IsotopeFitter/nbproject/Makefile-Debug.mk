...
LDLIBSOPTIONS=-L/usr/local/lib -L/home/matlab/Michal/glibcinstall/lib ../IsotopeFitLib/dist/Debug/GNU-Linux/libifl.a /usr/local/lib/libhdf5_cpp.a /usr/local/lib/libhdf5.a /usr/local/lib/libmatio.a /usr/local/lib/libsz.a /usr/local/lib/libz.a /home/matlab/Michal/glibcinstall/lib/libdl.a /home/matlab/Michal/glibcinstall/lib/libc.a /usr/local/lib/libgsl.a /usr/local/lib/libgslcblas.a
...
${OBJECTDIR}/src/DebugUtils.o: src/DebugUtils.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DebugUtils.o src/DebugUtils.cpp

${OBJECTDIR}/src/DesignMatrix.o: src/DesignMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DesignMatrix.o src/DesignMatrix.cpp
...
${OBJECTDIR}/src/LeastSquares.o: src/LeastSquares.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LeastSquares.o src/LeastSquares.cpp

${OBJECTDIR}/storage/Snippets.o: storage/Snippets.cpp 
	${MKDIR} -p ${OBJECTDIR}/storage
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/storage/Snippets.o storage/Snippets.cpp
...
${TESTDIR}/TestFiles/f5: ${TESTDIR}/tests/fittingtest2.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}  -static -o ${TESTDIR}/TestFiles/f5 $^ ${LDLIBSOPTIONS} 
...
${TESTDIR}/TestFiles/f6: ${TESTDIR}/tests/qrfittingdemo.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}  -static -o ${TESTDIR}/TestFiles/f6 $^ ${LDLIBSOPTIONS} 
...
${TESTDIR}/tests/fittingtest2.o: tests/fittingtest2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/fittingtest2.o tests/fittingtest2.cpp
...
${TESTDIR}/tests/qrfittingdemo.o: tests/qrfittingdemo.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/qrfittingdemo.o tests/qrfittingdemo.cpp
...
${OBJECTDIR}/src/DebugUtils_nomain.o: ${OBJECTDIR}/src/DebugUtils.o src/DebugUtils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DebugUtils_nomain.o src/DebugUtils.cpp;\
	else  \
...
${OBJECTDIR}/src/DesignMatrix_nomain.o: ${OBJECTDIR}/src/DesignMatrix.o src/DesignMatrix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DesignMatrix_nomain.o src/DesignMatrix.cpp;\
	else  \
...
${OBJECTDIR}/src/LeastSquares_nomain.o: ${OBJECTDIR}/src/LeastSquares.o src/LeastSquares.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LeastSquares_nomain.o src/LeastSquares.cpp;\
	else  \
...
${OBJECTDIR}/storage/Snippets_nomain.o: ${OBJECTDIR}/storage/Snippets.o storage/Snippets.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/include -I/home/matlab/Michal/glibcinstall/include -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/storage/Snippets_nomain.o storage/Snippets.cpp;\
	else  \
