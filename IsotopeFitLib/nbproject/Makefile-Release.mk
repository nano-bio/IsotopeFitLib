...
${OBJECTDIR}/src/HDF5Func.o: src/HDF5Func.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HDF5Func.o src/HDF5Func.cpp

${OBJECTDIR}/src/fitting.o: src/fitting.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fitting.o src/fitting.cpp

${OBJECTDIR}/src/ifdfile.o: src/ifdfile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ifdfile.o src/ifdfile.cpp
